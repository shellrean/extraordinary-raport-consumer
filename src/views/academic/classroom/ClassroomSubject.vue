<template>
  <div>
    <header class="mb-1 flex justify-between">
      ...
      <router-link v-if="!academic_active.archive" :to="{name: 'academic.classroom.subject', params: {id: $route.params.id}}" class="hover:shadow-lg font-normal text-xs py-1 px-4 rounded-full bg-blue-100 text-blue-600 border-blue-300 border">Edit</router-link>
    </header>
