    ...
    <div class="w-full lg:w-3/4 lg:py-4 lg:px-4">
      <div class="bg-white py-2 px-2 border border-gray-300 shadow rounded-t-lg mb-2">
        ...
        <div class="flex space-x-4">
          <div class="w-12 bg-gray-200">
            
          </div>
          <div class="flex-1">
            <input type="text" class="py-1 rounded-full px-6 bg-gray-100 w-full focus:ring-2" placeholder="Cari"/>
          </div>
        </div>
      </div>
      <div class="max-h-96 overflow-y-scroll">
        <div class="bg-white mb-2 border border-gray-300 shadow rounded-lg transition duration-500 hover:shadow-xl cursor-pointer" v-for="classroom in classrooms">
          <div class="flex flex-col sm:flex-row py-2 sm:justify-between sm:items-center">
            <div>
              <div class="px-3 font-semibold text-gray-700">V11-A - 11</div>
              <span class="px-3 text-gray-500 text-sm">Teknik Komputer Jaringan</span>
            </div>
            <span class="px-3 text-gray-500 text-sm">Prof.Dr. Shellrean. ST</span>
          </div>
        </div>
      </div>
      <div class="bg-white py-2 px-2 border border-gray-300 shadow rounded-b-lg mb-2">
        <router-link :to="{name: 'academic.classroom.create'}" class="py-1 px-4 border-gray-300 border bg-gray-100 text-gray-600 rounded-md">Buat kelas akademik</router-link>
      </div>
    </div>
