    ...
    <div class="h-full w-full mx-auto lg:flex-1 px-3 min-h-0 min-w-0">
      <div class="bg-white pt-6 pb-2 rounded-t-lg border-t border-l border-r border-gray-300 shadow-sm flex flex-col">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center px-4 mb-4">
          <p class="text-lg sm:text-2xl font-bold text-gray-500">Daftar kelas</p>
          <div class="flex space-x-1">
            <router-link to="/" class="py-2 text-sm px-4 rounded-md border border-gray-300 text-gray-600 disabled:opacity-50 text-white font-medium">Import kelas</router-link>
            <router-link :to="{name: 'dump.master.student.create' }" class="py-2 text-sm px-4 rounded-md bg-blue-400 disabled:opacity-50 text-white font-medium">Tambah kelas</router-link>
          </div>
        </div>
        ...
        <div class="flex px-2 flex-col border-t border-b py-2 border-gray-300 sm:flex-row py-1 justify-between sm:items-center border-gray-300">
          <div class="sm:px-1 flex items-center">
            ...
            <div class="flex flex-col">
              <p class="sm:px-3 font-medium text-gray-600 text-sm">INFO KELAS</p>
            </div>
          </div>
      ...
      <perfect-scrollbar class="max-h-96 overflow-y-scroll">
        <div class="bg-white py-2 px-2 border-l border-r border-gray-300">
          <div class="hover:bg-gray-50 p-1 sm:p-0 mb-1 border-b border-gray-200" v-for="(classroom,index) in classrooms" :key="index">
            <div class="flex flex-col sm:flex-row py-1 justify-between sm:items-center">
              <div class="sm:px-1 flex items-center">
                ...
                <div class="flex flex-col">
                  <p class="sm:px-3 text-xs text-gray-700">Tingkat {{ classroom.grade }}</p>
                  <p class="sm:px-3 text-gray-700">{{ classroom.name }}</p>
                </div>
              </div>
              <div class="flex space-x-1 pr-2 border-t md:border-0 border-gray-200 pt-2 md:pt-0">
