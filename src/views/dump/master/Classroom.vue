...
export default {
  ...
  data() {
    return {
      classrooms: [
        {id:3, major: 'Teknik Komputer Jaringan', grade: '10',name: 'X-TKJ'},
        {id:1, major: 'Teknik Komputer Jaringan', grade: '11',name: 'XI-TKJ'},
        {id:2, major: 'Teknik Komputer Jaringan', grade: '12',name: 'XII-TKJ'},
      ]
    }
  }
};
